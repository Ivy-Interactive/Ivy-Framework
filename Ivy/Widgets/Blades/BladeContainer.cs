...
{
    /// <summary>Each BladeView represents a memoized wrapper around a Blade widget that manages refresh tokens and provides optimized rendering for the blade navigation system.</summary>
