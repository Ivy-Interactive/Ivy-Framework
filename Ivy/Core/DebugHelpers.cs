...
internal static class DebugHelpers
{
    ...
    private static readonly string DumpFilePath = System.IO.Path.Combine(Directory.GetCurrentDirectory(), "dump.ljson");

    public static void LogUpdatedTree(JsonNode? oldTree, JsonNode? newTree, JsonNode? patch)
    {
