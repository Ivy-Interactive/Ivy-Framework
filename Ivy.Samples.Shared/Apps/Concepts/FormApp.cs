               ...
               | (Layout.Horizontal()
                | new Card(
                    smallModel.ToForm()
                        ...
                        .Group("Contact Details", open: false, m => m.PhoneNumber, m => m.Website)
                ...
                | new Card(
                    mediumModel.ToForm()
                        ...
                        .Group("Profile", open: false, m => m.Age, m => m.BirthDate, m => m.Role)
                        .Builder(m => m.Description, s => s.ToTextAreaInput())
                        .Builder(m => m.Password, s => s.ToPasswordInput())
                        .Builder(m => m.PhoneNumber, s => s.ToTelInput())
                        .Builder(m => m.Website, s => s.ToUrlInput())
                ...
                | new Card(
                    largeModel.ToForm()
                        ...
                        .Group("Details", open: false, m => m.Description, m => m.Color)
                        .Builder(m => m.Description, s => s.ToTextAreaInput())
                        .Builder(m => m.Password, s => s.ToPasswordInput())
                        .Builder(m => m.PhoneNumber, s => s.ToTelInput())
                        .Builder(m => m.Website, s => s.ToUrlInput())
