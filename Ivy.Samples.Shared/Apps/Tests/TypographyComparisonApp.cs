        ...
        return Layout.Grid().Columns(3).Gap(20)
            ...
            | new Card(
                ...
                | Layout.Vertical() // Unordered List simulation
                    ...
                    | (Layout.Horizontal().Gap(8) | Text.P("•") | Text.P("Unordered List Item 2"))
                | Layout.Vertical() // Ordered List simulation
                    | (Layout.Horizontal().Gap(8) | Text.P("1.") | Text.P("Ordered List Item 1"))
                    | (Layout.Horizontal().Gap(8) | Text.P("2.") | Text.P("Ordered List Item 2"))
