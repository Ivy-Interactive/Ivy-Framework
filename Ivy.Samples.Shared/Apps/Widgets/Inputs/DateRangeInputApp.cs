...
public class DateRangeInputApp : SampleBase
{
    protected override object? BuildSample()
    {
        ...
        var sizeExamplesGrid = Layout.Grid().Columns(4)
            ...
            | nullableDateOnlyState.ToDateRangeInput().Placeholder("Select date range").Format("yyyy-MM-dd").Scale(Scales.Medium).TestId("daterange-input-dateonly-medium")
            | nullableDateOnlyState.ToDateRangeInput().Placeholder("Select date range").Format("yyyy-MM-dd").Scale(Scales.Medium).TestId("daterange-input-dateonly-medium-nullable")
            | disabledNullableDateOnlyState.ToDateRangeInput().Placeholder("Select date range").Format("yyyy-MM-dd").Scale(Scales.Medium).Disabled().TestId("daterange-input-dateonly-medium-disabled")
