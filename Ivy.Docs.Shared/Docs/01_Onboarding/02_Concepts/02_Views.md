...
- **Hook access**: Built-in state management and effect [hooks](../../04_Hooks/02_RulesOfHooks.md)
...
Read the full guide on **[Rules of Hooks](../../04_Hooks/09_RulesOfHooks.md)** to learn more and troubleshoot common errors.
