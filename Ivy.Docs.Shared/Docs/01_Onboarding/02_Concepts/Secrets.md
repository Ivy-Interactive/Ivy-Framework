...
[Database connections](../../01_Onboarding/03_CLI/03_Database/01_DatabaseOverview.md) automatically declare their required secrets when generated through the [Ivy CLI](../../01_Onboarding/03_CLI/_Index.md). This integration ensures that your database connection strings are automatically included in secrets validation.

### Generated Connection Classes

When you generate a [database connection](../../01_Onboarding/03_CLI/03_Database/01_DatabaseOverview.md) using the [Ivy CLI](../../01_Onboarding/03_CLI/_Index.md), the generated connection class implements both `IConnection` and `IHaveSecrets`:
