...
<Ingress>
Build a complete todo application from scratch to learn essential Ivy concepts including [state management](../../04_Hooks/03_State.md), [components](../02_Concepts/03_Widgets.md), and [event handling](../02_Concepts/07_EventHandlers.md).
</Ingress>
