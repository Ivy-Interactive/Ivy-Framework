...
For information about the frontend architecture and widget rendering system, see [Frontend Architecture](./FrontendArchitecture.md). For details about the backend server framework and application hosting, see [Backend Architecture](./BackendArchitecture.md).
