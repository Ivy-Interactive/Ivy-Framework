...
For information about the React frontend system and widget rendering, see [Frontend Architecture](./FrontendArchitecture.md). For details on SignalR communication patterns, see [Communication](./Communication.md).
