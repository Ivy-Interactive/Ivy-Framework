...
<Ingress>
Learn the essential concepts of Ivy development including [Views](../02_Concepts/02_Views.md), [Widgets](../02_Concepts/03_Widgets.md), [state management](../../04_Hooks/03_State.md), and how to build your first interactive application.
</Ingress>
...
Ivy has a built-in state management system through the [UseState](../../04_Hooks/03_State.md) hook (similar to React).
