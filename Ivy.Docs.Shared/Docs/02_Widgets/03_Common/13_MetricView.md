...
The MetricView uses [UseQuery](../../01_Onboarding/02_Concepts/Query.md) hooks for data fetching, which automatically handle loading states with a skeleton loader. This is useful when fetching metrics from [databases](../../01_Onboarding/02_Concepts/01_Program.md) or APIs.
