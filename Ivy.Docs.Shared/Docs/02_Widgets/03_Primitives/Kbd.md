...
The `Kbd` [widget](../../../01_Onboarding/02_Concepts/Widgets.md) displays keyboard shortcuts or key combinations with proper styling. It helps users identify key commands and improves documentation clarity.
