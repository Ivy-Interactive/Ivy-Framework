...
export const ListItemWidget: React.FC<ListItemWidgetProps> = ({
  ...
  return (
    <button
      ...
      className="pl-2 pr-2 py-2 w-full h-14 flex-left flex items-center rounded-none hover:bg-accent focus:bg-accent focus:outline-none cursor-pointer min-w-0"
    >
