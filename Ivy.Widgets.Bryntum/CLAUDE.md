# Ivy.Widgets.Bryntum - Ivy External Widget
...
- **IIFE Bundle**: The React component is bundled as an IIFE and exposed on `window.Ivy_Widgets_Bryntum`
...
[ExternalWidget("frontend/dist/Ivy_Widgets_Bryntum.js", ExportName = "MyWidget")]
...
In React, call `$onEvent(eventName, widgetId, args)`:
...
# Build the frontend (creates dist/Ivy_Widgets_Bryntum.js)
npm run build
