        ...
        return Layout.Horizontal()
                | new Card(
                    smallModel.ToForm()
                        ...
                        .Builder(m => m.EmailField, s => s.ToEmailField())
                        .Builder(m => m.PasswordField, s => s.ToPasswordField())
                        .Builder(m => m.SearchField, s => s.ToSearchInput())
                        .Builder(m => m.TelField, s => s.ToTelField())
                        .Description(m => m.TelField, "Enter your phone number.")
                        .Builder(m => m.UrlField, s => s.ToUrlField())
