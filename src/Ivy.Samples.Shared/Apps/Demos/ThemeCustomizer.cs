                ...
                | new Expandable(
                    ...
                    content: Layout.Vertical()
                        ...
                        | (Layout.Grid().Columns(4).Gap(2)
                            | new ColorInput(currentColors.Primary ?? "#000000", e => UpdateColor(c => c.Primary = e.Value), placeholder: "Primary", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Primary").WithTooltip($"Primary: {currentColors.Primary ?? "#000000"}")
                            | new ColorInput(currentColors.PrimaryForeground ?? "#000000", e => UpdateColor(c => c.PrimaryForeground = e.Value), placeholder: "Primary Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Primary Foreground: {currentColors.PrimaryForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Secondary ?? "#000000", e => UpdateColor(c => c.Secondary = e.Value), placeholder: "Secondary", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Secondary").WithTooltip($"Secondary: {currentColors.Secondary ?? "#000000"}")
                            | new ColorInput(currentColors.SecondaryForeground ?? "#000000", e => UpdateColor(c => c.SecondaryForeground = e.Value), placeholder: "Secondary Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Secondary Foreground: {currentColors.SecondaryForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Background ?? "#000000", e => UpdateColor(c => c.Background = e.Value), placeholder: "Background", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Background").WithTooltip($"Background: {currentColors.Background ?? "#000000"}")
                            | new ColorInput(currentColors.Foreground ?? "#000000", e => UpdateColor(c => c.Foreground = e.Value), placeholder: "Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Foreground: {currentColors.Foreground ?? "#000000"}"))

                        | new Separator()

                        | Text.Block("Semantic Colors").Small()
                        | (Layout.Grid().Columns(4).Gap(2)
                            | new ColorInput(currentColors.Success ?? "#000000", e => UpdateColor(c => c.Success = e.Value), placeholder: "Success", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Success").WithTooltip($"Success: {currentColors.Success ?? "#000000"}")
                            | new ColorInput(currentColors.SuccessForeground ?? "#000000", e => UpdateColor(c => c.SuccessForeground = e.Value), placeholder: "Success Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Success Foreground: {currentColors.SuccessForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Destructive ?? "#000000", e => UpdateColor(c => c.Destructive = e.Value), placeholder: "Destructive", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Destructive").WithTooltip($"Destructive: {currentColors.Destructive ?? "#000000"}")
                            | new ColorInput(currentColors.DestructiveForeground ?? "#000000", e => UpdateColor(c => c.DestructiveForeground = e.Value), placeholder: "Destructive Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Destructive Foreground: {currentColors.DestructiveForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Warning ?? "#000000", e => UpdateColor(c => c.Warning = e.Value), placeholder: "Warning", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Warning").WithTooltip($"Warning: {currentColors.Warning ?? "#000000"}")
                            | new ColorInput(currentColors.WarningForeground ?? "#000000", e => UpdateColor(c => c.WarningForeground = e.Value), placeholder: "Warning Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Warning Foreground: {currentColors.WarningForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Info ?? "#000000", e => UpdateColor(c => c.Info = e.Value), placeholder: "Info", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Info").WithTooltip($"Info: {currentColors.Info ?? "#000000"}")
                            | new ColorInput(currentColors.InfoForeground ?? "#000000", e => UpdateColor(c => c.InfoForeground = e.Value), placeholder: "Info Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Info Foreground: {currentColors.InfoForeground ?? "#000000"}")
      )
                        ...
                        | (Layout.Grid().Columns(4).Gap(2)
                            | new ColorInput(currentColors.Muted ?? "#000000", e => UpdateColor(c => c.Muted = e.Value), placeholder: "Muted", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Muted").WithTooltip($"Muted: {currentColors.Muted ?? "#000000"}")
                            | new ColorInput(currentColors.MutedForeground ?? "#000000", e => UpdateColor(c => c.MutedForeground = e.Value), placeholder: "Muted Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Muted Foreground: {currentColors.MutedForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Accent ?? "#000000", e => UpdateColor(c => c.Accent = e.Value), placeholder: "Accent", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Accent").WithTooltip($"Accent: {currentColors.Accent ?? "#000000"}")
                            | new ColorInput(currentColors.AccentForeground ?? "#000000", e => UpdateColor(c => c.AccentForeground = e.Value), placeholder: "Accent Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Accent Foreground: {currentColors.AccentForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Border ?? "#000000", e => UpdateColor(c => c.Border = e.Value), placeholder: "Border", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Border").WithTooltip($"Border: {currentColors.Border ?? "#000000"}")
                            | new ColorInput(currentColors.Input ?? "#000000", e => UpdateColor(c => c.Input = e.Value), placeholder: "Input", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Input").WithTooltip($"Input: {currentColors.Input ?? "#000000"}")
                            | new ColorInput(currentColors.Ring ?? "#000000", e => UpdateColor(c => c.Ring = e.Value), placeholder: "Ring", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Ring").WithTooltip($"Ring: {currentColors.Ring ?? "#000000"}")
                            | new ColorInput(currentColors.Card ?? "#000000", e => UpdateColor(c => c.Card = e.Value), placeholder: "Card", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Card").WithTooltip($"Card: {currentColors.Card ?? "#000000"}")
                            | new ColorInput(currentColors.CardForeground ?? "#000000", e => UpdateColor(c => c.CardForeground = e.Value), placeholder: "Card Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Card Foreground: {currentColors.CardForeground ?? "#000000"}")
                            | new ColorInput(currentColors.Popover ?? "#000000", e => UpdateColor(c => c.Popover = e.Value), placeholder: "Popover", variant: ColorInputs.ThemePicker).WithField().Medium().Description("Popover").WithTooltip($"Popover: {currentColors.Popover ?? "#000000"}")
                            | new ColorInput(currentColors.PopoverForeground ?? "#000000", e => UpdateColor(c => c.PopoverForeground = e.Value), placeholder: "Popover Foreground", variant: ColorInputs.ThemePicker).Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Popover Foreground: {currentColors.PopoverForeground ?? "#000000"}")
      )
