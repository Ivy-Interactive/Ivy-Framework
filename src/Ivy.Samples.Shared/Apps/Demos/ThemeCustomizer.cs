      ...
      Action<Theme> loadPreset) : ViewBase
  {
    public override object Build()
    {
      ...
      return Layout.Vertical()
          ...
          | new Expandable(
              header: Text.Block("Colors Alternative Example").Bold(),
              content: Layout.Vertical()
                  | Text.Block("Main Colors").Small()
                  | (Layout.Grid().Columns(4).Gap(2)
                      | new ColorInput(currentColors.Primary ?? "#000000", e => UpdateColor(c => c.Primary = e.Value), variant: ColorInputs.Picker).WithField().Description("Primary").WithTooltip($"Primary: {currentColors.Primary ?? "#000000"}")
                      | new ColorInput(currentColors.PrimaryForeground ?? "#000000", e => UpdateColor(c => c.PrimaryForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Primary Foreground: {currentColors.PrimaryForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Secondary ?? "#000000", e => UpdateColor(c => c.Secondary = e.Value), variant: ColorInputs.Picker).WithField().Description("Secondary").WithTooltip($"Secondary: {currentColors.Secondary ?? "#000000"}")
                      | new ColorInput(currentColors.SecondaryForeground ?? "#000000", e => UpdateColor(c => c.SecondaryForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Secondary Foreground: {currentColors.SecondaryForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Background ?? "#000000", e => UpdateColor(c => c.Background = e.Value), variant: ColorInputs.Picker).WithField().Description("Background").WithTooltip($"Background: {currentColors.Background ?? "#000000"}")
                      | new ColorInput(currentColors.Foreground ?? "#000000", e => UpdateColor(c => c.Foreground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Foreground: {currentColors.Foreground ?? "#000000"}"))

                  | new Separator()

                  | Text.Block("Semantic Colors").Small()
                  | (Layout.Grid().Columns(4).Gap(2)
                      | new ColorInput(currentColors.Success ?? "#000000", e => UpdateColor(c => c.Success = e.Value), variant: ColorInputs.Picker).WithField().Description("Success").WithTooltip($"Success: {currentColors.Success ?? "#000000"}")
                      | new ColorInput(currentColors.SuccessForeground ?? "#000000", e => UpdateColor(c => c.SuccessForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Success Foreground: {currentColors.SuccessForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Destructive ?? "#000000", e => UpdateColor(c => c.Destructive = e.Value), variant: ColorInputs.Picker).WithField().Description("Destructive").WithTooltip($"Destructive: {currentColors.Destructive ?? "#000000"}")
                      | new ColorInput(currentColors.DestructiveForeground ?? "#000000", e => UpdateColor(c => c.DestructiveForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Destructive Foreground: {currentColors.DestructiveForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Warning ?? "#000000", e => UpdateColor(c => c.Warning = e.Value), variant: ColorInputs.Picker).WithField().Description("Warning").WithTooltip($"Warning: {currentColors.Warning ?? "#000000"}")
                      | new ColorInput(currentColors.WarningForeground ?? "#000000", e => UpdateColor(c => c.WarningForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Warning Foreground: {currentColors.WarningForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Info ?? "#000000", e => UpdateColor(c => c.Info = e.Value), variant: ColorInputs.Picker).WithField().Description("Info").WithTooltip($"Info: {currentColors.Info ?? "#000000"}")
                      | new ColorInput(currentColors.InfoForeground ?? "#000000", e => UpdateColor(c => c.InfoForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Info Foreground: {currentColors.InfoForeground ?? "#000000"}")
)
                  ...
                  | (Layout.Grid().Columns(4).Gap(2)
                      | new ColorInput(currentColors.Muted ?? "#000000", e => UpdateColor(c => c.Muted = e.Value), variant: ColorInputs.Picker).WithField().Description("Muted").WithTooltip($"Muted: {currentColors.Muted ?? "#000000"}")
                      | new ColorInput(currentColors.MutedForeground ?? "#000000", e => UpdateColor(c => c.MutedForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Muted Foreground: {currentColors.MutedForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Accent ?? "#000000", e => UpdateColor(c => c.Accent = e.Value), variant: ColorInputs.Picker).WithField().Description("Accent").WithTooltip($"Accent: {currentColors.Accent ?? "#000000"}")
                      | new ColorInput(currentColors.AccentForeground ?? "#000000", e => UpdateColor(c => c.AccentForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Accent Foreground: {currentColors.AccentForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Border ?? "#000000", e => UpdateColor(c => c.Border = e.Value), variant: ColorInputs.Picker).WithField().Description("Border").WithTooltip($"Border: {currentColors.Border ?? "#000000"}")
                      | new ColorInput(currentColors.Input ?? "#000000", e => UpdateColor(c => c.Input = e.Value), variant: ColorInputs.Picker).WithField().Description("Input").WithTooltip($"Input: {currentColors.Input ?? "#000000"}")
                      | new ColorInput(currentColors.Ring ?? "#000000", e => UpdateColor(c => c.Ring = e.Value), variant: ColorInputs.Picker).WithField().Description("Ring").WithTooltip($"Ring: {currentColors.Ring ?? "#000000"}")
                      | new ColorInput(currentColors.Card ?? "#000000", e => UpdateColor(c => c.Card = e.Value), variant: ColorInputs.Picker).WithField().Description("Card").WithTooltip($"Card: {currentColors.Card ?? "#000000"}")
                      | new ColorInput(currentColors.CardForeground ?? "#000000", e => UpdateColor(c => c.CardForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Card Foreground: {currentColors.CardForeground ?? "#000000"}")
                      | new ColorInput(currentColors.Popover ?? "#000000", e => UpdateColor(c => c.Popover = e.Value), variant: ColorInputs.Picker).WithField().Description("Popover").WithTooltip($"Popover: {currentColors.Popover ?? "#000000"}")
                      | new ColorInput(currentColors.PopoverForeground ?? "#000000", e => UpdateColor(c => c.PopoverForeground = e.Value), variant: ColorInputs.Picker).WithField().Description("\u00A0").WithTooltip($"Popover Foreground: {currentColors.PopoverForeground ?? "#000000"}")
)
