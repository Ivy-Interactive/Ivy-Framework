...
public class ThemeCustomizer : SampleBase
{
  protected override object? BuildSample()
  {
    ...
    var themeService = Context.UseService<IThemeService>();
          ...
          | new Expandable(
              ...
              content: Layout.Vertical()
                  ...
                  | (Layout.Grid().Columns(4).Gap(2)
                      ...
                      | new ThemeColorPicker(currentColors.Foreground ?? "#000000", e => UpdateColor(c => c.Foreground = e.Value), placeholder: "Background Foreground").Foreground(true).WithField().Medium().Description("\u00A0").WithTooltip($"Background Foreground: {currentColors.Foreground ?? "#000000"}"))
