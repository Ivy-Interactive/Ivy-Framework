    ...
    public override object? Build()
    {
        return Layout.Vertical()
            ...
            | (Layout.Grid()
                ...
                .Gap(2)
                .Height(Size.Px(200))
                | "Header".WithCell().Color(Colors.Blue).GridColumnSpan(3)
                | "Sidebar".WithCell().Color(Colors.Green).GridRowSpan(2)
                | "Main".WithCell().Color(Colors.Orange)
                | "Aside".WithCell().Color(Colors.Rose)
                | "Footer 1".WithCell()
                | "Footer 2".WithCell()
              )
