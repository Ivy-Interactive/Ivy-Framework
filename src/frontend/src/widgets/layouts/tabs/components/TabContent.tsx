      ...
      <div className="ml-2 items-center flex gap-0">
        {isActive && showRefresh && (
          <button
            ...
            className="opacity-60 p-1 rounded-full border border-transparent hover:border-border hover:bg-accent hover:text-accent-foreground hover:opacity-100 transition-colors cursor-pointer"
          >
        ...
        {showClose && (
          <button
            ...
            className={cn(
              "opacity-60 p-1 rounded-full border border-transparent hover:border-border hover:bg-accent hover:text-accent-foreground hover:opacity-100 transition-colors cursor-pointer",
