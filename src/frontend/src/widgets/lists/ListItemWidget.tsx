...
export const ListItemWidget: React.FC<ListItemWidgetProps> = ({
  ...
  return (
    <button
      ...
      className="pl-4 pr-4 w-full h-full flex-left flex items-center gap-3 rounded-none hover:bg-accent focus:bg-accent focus:outline-none cursor-pointer min-w-0"
    >
