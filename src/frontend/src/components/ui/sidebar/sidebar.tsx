      ...
      >
        ...
        >
          <div
            ...
            className="flex h-full w-full flex-col bg-background group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-border"
          >
            {children}
          </div>
        </div>
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        'h-8 w-full bg-background focus-visible:ring-2 focus-visible:ring-ring',
        className
      )}
      {...props}
    />
