...
public static class WidgetBaseExtensions
{
    ...
    public static T Small<T>(this T widget) where T : WidgetBase<T> => widget with { Density = Shared.Density.Small };

    public static T Medium<T>(this T widget) where T : WidgetBase<T> => widget with { Density = Shared.Density.Medium };

    public static T Large<T>(this T widget) where T : WidgetBase<T> => widget with { Density = Shared.Density.Large };
