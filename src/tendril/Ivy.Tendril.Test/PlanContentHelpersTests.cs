...
public class PlanContentHelpersTests
{
    ...
    private class StubGitService(string? commitTitle = null, int? fileCount = null) : IGitService
    {
        ...
        public int? GetCommitFileCount(string repoPath, string commitHash) => fileCount;
    }
