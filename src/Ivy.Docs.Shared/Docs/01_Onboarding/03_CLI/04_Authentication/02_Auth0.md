...
2. **Set Allowed Callback URLs** to `http://localhost:5010/ivy/auth/oauth-callback`, replacing the base URL (`http://localhost:5010`) with your application's URL: ![Auth0 Allowed Callback URLs](/ivy/assets/auth0_callback.webp "Auth0 Allowed Callback URLs")
3. **Click "Save"**
