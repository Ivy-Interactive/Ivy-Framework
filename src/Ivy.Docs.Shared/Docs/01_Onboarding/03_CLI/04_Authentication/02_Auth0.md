...
2. **Set Allowed Callback URLs** to `https://localhost:5010/ivy/auth/callback`, replacing the base URL (`https://localhost:5010`) with your application's URL: ![Auth0 Allowed Callback URLs](/ivy/assets/auth0_callback.webp "Auth0 Allowed Callback URLs")
3. **Click "Save"**
