...
![Entra client and tenant IDs](/ivy/_assets/entra_client_and_tenant_ids.webp "Entra client and tenant IDs")
...
![Newly-created Entra client secret](/ivy/_assets/entra_client_secret.webp "Newly-created Entra client secret")
...
![ID tokens enabled](/ivy/_assets/entra_id_tokens_enabled.webp "ID tokens enabled")
