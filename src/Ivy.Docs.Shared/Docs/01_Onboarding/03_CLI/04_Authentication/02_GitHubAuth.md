...
3. Fill in the application details:
   ...
   - **Authorization callback URL**: Your application's callback endpoint (e.g., `http://localhost:5010/ivy/auth/oauth-callback` for local development or `https://your-app.com/ivy/auth/oauth-callback` for production)
