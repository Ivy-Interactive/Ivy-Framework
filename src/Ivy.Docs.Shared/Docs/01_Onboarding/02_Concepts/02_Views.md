...
- **Service injection**: Access to [application services](../../03_Hooks/Core/11_Service.md)
...
Use `UseEffect()` for [side effects](../../03_Hooks/Core/04_Effect.md) like API calls, timers, or [subscriptions](../../03_Hooks/Core/10_Signal.md):
