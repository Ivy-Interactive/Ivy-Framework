    ...
    public override object? Build()
    {
        ...
        return Layout.Horizontal(
            new Button("Success Toast", _ => 
                client.Toast("Operation completed successfully!", "Success", ToastVariant.Success)
            ),
            new Button("Error Toast", _ => 
                client.Toast("Something went wrong!", "Error", ToastVariant.Destructive)
            ),
            new Button("Info Toast", _ => 
                client.Toast("Here's some helpful information", "Info", ToastVariant.Info)
            ),
