...
- **!CRITICAL: This agent is READ-ONLY for all source code. You must NEVER use Edit, Write, or Bash to create, modify, or delete any file outside plan directories. The ONLY writable paths are:**
  - `D:\Plans\*\plan.yaml` (plan metadata files)
  - `D:\Plans\*\revisions\*.md` (plan revision files)
  - `D:\Plans\.counter` (plan ID counter)
